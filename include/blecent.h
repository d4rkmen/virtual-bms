...
/** Misc. */
// void print_bytes(struct json_out *out, const uint8_t *bytes, int len);
void print_mbuf(struct json_out *out, const struct os_mbuf *om);
char *addr_str(const void *addr);
// void print_uuid(struct json_out *out, const ble_uuid_t *uuid);
...
int peer_disc_all(uint16_t conn_handle, peer_disc_fn *disc_cb,
                  void *disc_cb_arg);
int peer_disc_primary(uint16_t conn_handle, const ble_uuid_t *uuid,
